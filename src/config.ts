...
export const config = {
  ...
  hackerrank: '@BleakRed',
  youtubeApiKey: '',
  youtubeChannelId: '@BleakRedMN',

  // ── About Section (Markdown) ──
  about: `# About Me

Final-year university student with a passion for full-stack development. I've built collaborative web apps with real-time features, real-time drawing tools, and kanban systems — the kind of projects that become real tools people actually use.
...
- Wrapping up my final year at university
  ...
  projects: [
    {
      ...
      live: 'https://notion-clone.example.com',
      source: 'https://github.com/bleakred/notion-clone',
    },
    {
      ...
      live: 'https://bleakred.github.io/portfolio',
      source: 'https://github.com/bleakred/portfolio',
    },
  ],
};
